import { o as onDestroy, s as setContext, g as getContext, c as create_ssr_component, b as compute_rest_props, d as spread, f as escape_object, h as add_attribute, i as escape_attribute_value, a as subscribe, n as noop$1, v as validate_component, e as escape } from "../../chunks/ssr.js";
...
const Avatar$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { el = void 0 } = $$props;
  const { states: { loadingStatus: localLoadingStatus }, updateOption, getAttrs: getAttrs2 } = setCtx({
    src: "",
    delayMs,
...
const Avatar_fallback$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { asChild = false } = $$props;
  let { el = void 0 } = $$props;
  const { elements: { fallback }, getAttrs: getAttrs2 } = getCtx();
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="grid h-screen w-screen grid-cols-[1fr_3fr_2fr] grid-rows-[11fr_1fr]"><div class="flex flex-col items-center space-y-8 border border-red-500"><h1>Room : ${escape($roomId)}</h1> ${!$roomId ? `${validate_component(Button, "Button").$$render($$result, { variant: "outline" }, {}, {
      default: () => {
        return `createRoom`;
      }
    ...
    })}</div></div> <div class="flex flex-col items-center justify-center border border-blue-500">${validate_component(Avatar, "Avatar.Root").$$render($$result, { class: "h-96 w-96 rounded-2xl" }, {}, {
      default: () => {
