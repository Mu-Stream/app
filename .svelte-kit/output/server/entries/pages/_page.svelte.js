...
function setCtx(props) {
  ...
  const avatar = {
    ...createAvatar(removeUndefined(props)),
    getAttrs: getAttrs2,
  };
...
const Avatar$1 = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    if (
      $$props.loadingStatus === void 0 &&
      $$bindings.loadingStatus &&
      loadingStatus !== void 0
    )
      $$bindings.loadingStatus(loadingStatus);
    if (
      $$props.onLoadingStatusChange === void 0 &&
      $$bindings.onLoadingStatusChange &&
      onLoadingStatusChange !== void 0
    )
...
const Avatar_image$1 = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let image;
    let builder2;
    let $$restProps = compute_rest_props($$props, [
    ...
    let $image,
      $$unsubscribe_image = noop$1,
      $$subscribe_image = () => (
        $$unsubscribe_image(),
        ($$unsubscribe_image = subscribe(
          image,
          ($$value) => ($image = $$value),
        )),
        image
    ...
    return `${
      asChild
        ? `${slots.default ? slots.default({ builder: builder2 }) : ``}`
        : `<img${spread(
            [
...
const Avatar_fallback$1 = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let builder2;
    ...
    $$unsubscribe_fallback = subscribe(
      fallback,
...
const Avatar_image = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
...
const Avatar_fallback = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
...
const roomId = writable(void 0);
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $roomId, $$unsubscribe_roomId;
  $$unsubscribe_roomId = subscribe(roomId, (value) => ($roomId = value));
  let id;
  let $$settled;
  let $$rendered;
  ...
  do {
    ...
    $$rendered = `<div class="grid h-screen w-screen grid-cols-[1fr_3fr_2fr] grid-rows-[11fr_1fr]"><div class="flex flex-col items-center space-y-8 border border-red-500"><h1>Room : ${escape($roomId)}</h1> ${
      !$roomId
        ...
        : ``
    } <div class="flex flex-row space-x-2">${validate_component(
      Input,
      "Input",
    ).$$render(
      $$result,
      { placeholder: "RoomId", value: id },
      {
        value: ($$value) => {
          id = $$value;
          $$settled = false;
    ...
    )}</div></div> <div class="flex flex-col items-center justify-center border border-blue-500">${validate_component(
      Avatar,
      "Avatar.Root",
    ).$$render(
      $$result,
      ...
      {},
      {
        default: () => {
          return `${validate_component(Avatar_image, "Avatar.Image").$$render(
            ...
            {},
            {},
          )} ${validate_component(Avatar_fallback, "Avatar.Fallback").$$render(
            $$result,
            {},
            {},
            {
    ...
    )}</div> <div class="border border-yellow-500" data-svelte-h="svelte-1k0piss">playlist</div> <div class="col-span-3 border border-green-500" data-svelte-h="svelte-1r9tz44">current_playing</div></div>`;
  } while (!$$settled);
  $$unsubscribe_roomId();
  return $$rendered;
});
