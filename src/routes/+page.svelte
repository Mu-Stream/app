  ...
  let albums = [
    {
      ...
      artist: 'Daft Punk',
      imgUrl: 'https://upload.wikimedia.org/wikipedia/en/a/a7/Random_Access_Memories.jpg'
    },
    {
      title: 'Rumours',
      artist: 'Fleetwood Mac',
      imgUrl: 'https://upload.wikimedia.org/wikipedia/en/e/e3/Fleetwood_Mac_-_Rumours.jpg'
    },
    {
      ...
      <div class="overflow-y-scroll">
        {#each albums as album}
          <div class="flex items-center">
            <header class="card-header"><Avatar src={album.imgUrl} rounded="rounded-2xl" /></header>
            <div>
