...
export type WithPeerIentity<E extends Record<string, unknown>> = E & { identity: string }
...
export class Peer extends ProxyNotifier<PeerEventTypes, PeerEvents> {
	...
	public subscribe<T extends PeerEventTypes>(type: T, listener: Listener<WithPeerIentity<PeerEvents[T]>>): Subscription<PeerEvents[T]> {
